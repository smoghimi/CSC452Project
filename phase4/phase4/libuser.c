...
int SemP(int semaphore)
{
    ...
    int something = (long) sysArg.arg4;
    return something;
} /* end of SemP */
...
int SemFree(int semaphore)
{
    ...
    int something = (long) sysArgs.arg4;
    return something;
} /* end of SemFree */
...
void GetTimeofDay(int *tod)                           
{
    ...
    sysArgs.number = SYS_GETTIMEOFDAY;

    USLOSS_Syscall(&sysArgs);

    *tod = (long) sysArgs.arg1;
} /* end of GetTimeofDay */
...
void CPUTime(int *cpu)                           
{
    ...
    sysArgs.number = SYS_CPUTIME;

    USLOSS_Syscall(&sysArgs);

    *cpu = (long) sysArgs.arg1;
} /* end of CPUTime */
