...
int XXp1(char *arg)
{
    ...
    USLOSS_Console("XXp1(): zap'ing process with pid_z \n");
    status = zap(pid_z);
    USLOSS_Console("XXp1(): after zap'ing process with pid_z, status = %d\n",
                   status);
...
int XXp2(char *arg)
{
    ...
    USLOSS_Console("XXp2(): zap'ing process with pid_z \n");
    status = zap(pid_z);
    USLOSS_Console("XXp2(): after zap'ing process with pid_z, status = %d\n",
                   status);
